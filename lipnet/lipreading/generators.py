...
class BasicGenerator(keras.callbacks.Callback):
    ...
    def next_train(self):
        ...
        while 1:
            ...
            if epoch_differences > 0:
                ...
                #print("\nGENERATOR EPOCH {}".format(self.process_train_epoch))
                #print(self.train_list[0])
            # print "PI: {}, SI: {}, SE: {}".format(cur_train_index, self.cur_train_index.value, self.shared_train_epoch.value)
            #print("\nself.curriculum.epoch = ", self.curriculum.epoch, "self.process_train_epoch = ", self.process_train_epoch)
    ...
    def next_val(self):
        while 1:
            ...
            #print("Epoch {}: {}".format(self.process_epoch, self.curriculum))
